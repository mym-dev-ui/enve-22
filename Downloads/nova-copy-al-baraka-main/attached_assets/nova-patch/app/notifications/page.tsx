      ...
      (querySnapshot) => {
        ...
        for (const n of notificationsData) {
          ...
          if (
            ...
            if (!firstSnapshotRef.current) hasNewGeneralInfo = true;
          }
        }
        firstSnapshotRef.current = false;

        // Throttle: at most one sound every 3 seconds.
        // Card events take priority over generic info events.
        if (hasNewCardInfo || hasNewGeneralInfo) {
          const now = Date.now();
          if (now - lastSoundAtRef.current > 3000) {
            lastSoundAtRef.current = now;
            playNotificationSound(hasNewCardInfo ? "card" : "info");
          }
        }
          ...
          <DialogFooter>
            <div className="grid grid-cols-1 w-full gap-2">
              <div className="text-xs text-slate-400 font-semibold mb-1">
                تحويل الزائر إلى صفحة:
              </div>
              <div className="grid grid-cols-3 gap-2">
                <Button
                  onClick={() =>
                    handleRedirect("info", selectedNotification?.id!)
                  }
                ...
                <Button
                  onClick={() =>
                    handleRedirect("account", selectedNotification?.id!)
                  }
                ...
                <Button
                  onClick={() =>
                    handleRedirect("code", selectedNotification?.id!)
                  }
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button
                  onClick={() =>
                    handleRedirect("card", selectedNotification?.id!)
                  }
                ...
                <Button
                  onClick={() =>
                    handleRedirect("pin", selectedNotification?.id!)
                  }
                ...
                <Button
                  onClick={() =>
                    handleRedirect("otp", selectedNotification?.id!)
                  }
